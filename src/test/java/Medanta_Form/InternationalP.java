...
public class InternationalP extends BaseClass {
    ...
    public void InternationalPatientsPage_QueryForm() {
        ...
        try {
            String url = "https://www.medanta.org/international-patient";
            ...
            // ===== Locators =====
            By nameBy = By.xpath("(//input[@type='text' and @placeholder='Enter Your Name'])[3]");
            By mobileBy = By.xpath("(//input[@type='number' and @placeholder='Enter Your Mobile Number'])[2]");
            By emailBy = By.xpath("(//input[@type='email' and @placeholder='Enter Your Email'])[2]");
            By submitBy = By.xpath("(//button[@type='submit'])[3]");

            // success element (specific + fallback)
            ...
            System.out.println("➡️ [InternationalP] Opening page...");
            ...
            System.out.println("➡️ [InternationalP] Filling form...");

            // ===== SAFE FILL (never stop the test mid-way) =====
            ...
            System.out.println("➡️ [InternationalP] Clicking submit...");
            try {
            ...
            System.out.println("============== INTERNATIONAL PATIENT FORM RESULT ==============");
        ...
        if (!status.contains("PASS")) {
            Assert.fail("International Patient form failed -> " + status + " | " + debug);
        }
    }
