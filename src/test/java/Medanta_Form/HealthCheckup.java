...
public class HealthCheckup extends BaseClass{
    ...
    @Test(priority = 1)
    public void HealthCheckup_RequestACallbackForm() throws Throwable {
        ...
        try {
            ...
            writeExcel(13, 4, "✅ FORM SUBMITTED SUCCSESSFULLY!");
            ...
            writeExcel(13, 4, "❌ FORM NOT SUBMITTED SUCCSESSFULLY! FAIL");
            writeExcel(13, 5, finalResult);
            Thread.sleep(3000);
            Assert.fail("Health Checkup validation failed: " + finalResult);
            Thread.sleep(3000);
        }
    }
