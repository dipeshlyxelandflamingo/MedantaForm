...
public class CulturalEDP extends BaseClass {
	 ...
	 @Test(priority = 1)
	    public void CulturalEventDetailPage_QueryForm() {
	        ...
	        try {
	            String url = "https://www.medanta.org/careers/events/cultural-events";
	            ...
	            System.out.println("➡️ [CulturalEDP] Opening page...");
	            ...
	            System.out.println("➡️ [CulturalEDP] Filling form...");
	            ...
	            // ===== Submit =====
	            System.out.println("➡️ [CulturalEDP] Clicking submit...");
	            ...
	            // ===== PRINT =====
	            System.out.println("============== CULTURAL EVENT FORM RESULT ==============");
	        ...
	        if (!status.contains("PASS")) {
	            Assert.fail("Cultural Event Query form failed -> " + status + " | " + debug);
	        }
	    }
