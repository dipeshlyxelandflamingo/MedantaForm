...
public class BuyMedicine extends BaseClass {
	...
	public void TC_01() {
		...
		try {
			...
			if (msg.contains("Thank you")) {
				...
				sheet.getRow(13).createCell(5).setCellValue("PASS!");
			} else {
				System.out.println("FAIL");
				sheet.getRow(13).createCell(5).setCellValue("FAIL!");
			}
	...
	public void TC_02() {
		...
		try {
			...
			if (msg.contains("Thank you")) {
				System.out.println("PASS");
				sheet.getRow(14).createCell(5).setCellValue("PASS!");
			} else {
				System.out.println("FAIL");
				sheet.getRow(14).createCell(5).setCellValue("FAIL!");
			}
