...
public class Headerform extends BaseClass {
    ...
    public void Header_RequestACallBackForm() {
        ...
        try {
            ...
            // ===== Open Request Call Back modal (safe) =====
            try {
            ...
            // ✅ inputs ALWAYS captured (even if some empty)
            inputs =
